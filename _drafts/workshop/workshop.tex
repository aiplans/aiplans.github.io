...
%  Language Designer & PL Theorist & ML \\
    ...
    \begin{figure}[H]
        ...
        \end{tikzpicture}
        \caption{A tentative timeline for our proposed workshop at NeurIPS 2021.}
    \end{figure}
    ...
    \begin{table}[h!]
        \begin{center}
            \begin{tabular}{ c p{10.5cm}}
                ...
                \raisebox{-\totalheight}{\includegraphics[width=0.2\textwidth]{img/organizers/chin-wei}} & \textbf{Chin-Wei Huang}
                ...
                \raisebox{-\totalheight}{\includegraphics[width=0.2\textwidth]{img/organizers/shawn}} & \vspace*{0.4cm}\textbf{Shawn Tan} is a Ph.D. candidate at Mila, Universit\'e de Montr\'eal.
